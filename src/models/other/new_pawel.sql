WITH FAKE_DATA AS (
    SELECT
      ...
      -- Char
      cast('A' as Varchar(1)) AS HAI_CHAR_COLUMN_STUFF,
      -- Character
      ...
      -- Geography
      TO_GEOGRAPHY('POINT(-122.35 37.55)') AS HAI_GEOGRAPHY_COLUMN_STUFF ,
      TO_GEOMETRY('POINT(1820.12 890.56)') as HAI_GEOMETRY_COLUMN_STUFF union all
      SELECT
      ...
      TO_GEOGRAPHY(Null) AS HAI_GEOGRAPHY_COLUMN_STUFF,
      Null as HAI_GEOMETRY_COLUMN_STUFF union all
      SELECT
      -- Number
      ...
      -- Char
      cast('f' as Varchar(1)) AS HAI_CHAR_COLUMN_STUFF,
      -- Character
      'B' AS HAI_CHARACTER_COLUMN_STUFF,
      -- String
      'Hello' AS HAI_STRING_COLUMN_STUFF,
      ...
      TO_GEOMETRY('POINT(1340.12 890.56)') as HAI_GEOMETRY_COLUMN_STUFF 
  )
  SELECT *
  FROM FAKE_DATA
